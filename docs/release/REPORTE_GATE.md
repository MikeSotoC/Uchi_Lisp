...
./docs/release/SMOKE_TEST_CAD.md:35:25. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:38:- No hay mezcla de `app/` entre instalaciones.
