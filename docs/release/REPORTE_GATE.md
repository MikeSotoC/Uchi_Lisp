...
./docs/release/SMOKE_TEST_CAD.md:53:43. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:56:- No hay mezcla de `app/` entre instalaciones.
