...
./docs/release/SMOKE_TEST_CAD.md:27:17. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:30:- No hay mezcla de `app/` entre instalaciones.
```
