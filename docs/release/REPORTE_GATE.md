...
./docs/release/SMOKE_TEST_CAD.md:52:42. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:55:- No hay mezcla de `app/` entre instalaciones.
