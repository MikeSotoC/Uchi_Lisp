...
./docs/release/SMOKE_TEST_CAD.md:57:47. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:60:- No hay mezcla de `app/` entre instalaciones.
