...
./docs/release/SMOKE_TEST_CAD.md:43:33. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:46:- No hay mezcla de `app/` entre instalaciones.
