...
./docs/release/SMOKE_TEST_CAD.md:49:39. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:52:- No hay mezcla de `app/` entre instalaciones.
