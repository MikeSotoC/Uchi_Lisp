...
./docs/release/SMOKE_TEST_CAD.md:26:16. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:29:- No hay mezcla de `app/` entre instalaciones.
