...
./docs/release/SMOKE_TEST_CAD.md:39:29. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:42:- No hay mezcla de `app/` entre instalaciones.
