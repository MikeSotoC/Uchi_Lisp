...
./docs/release/SMOKE_TEST_CAD.md:40:30. Restaurar módulos y repetir APPLOAD en A.
./docs/release/SMOKE_TEST_CAD.md:43:- No hay mezcla de `app/` entre instalaciones.
