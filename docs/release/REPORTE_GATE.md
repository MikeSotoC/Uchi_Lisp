...
./main.lsp:78:  ;; 1) app/ relativo al launcher cargado por APPLOAD.
./main.lsp:116:    (progn (load full nil) T)
./main.lsp:128:      (uchi:log "ERROR no se pudo resolver app/. Use UCHI_APP_DIR válido o selección manual.")
