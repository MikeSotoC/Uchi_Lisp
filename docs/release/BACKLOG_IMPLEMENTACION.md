...
11.1 **Subdivisión**: módulo `UCHI_SUBDIVISION` ya usa boundary, reserva vial configurable (`ROAD_EVERY`) y filtros de área mínima; falta reglas municipales avanzadas (frentes mínimos, aportes y equipamiento).
